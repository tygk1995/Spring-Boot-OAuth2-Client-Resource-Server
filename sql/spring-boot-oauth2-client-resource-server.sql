...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('5e03fb292edd4e478cd7b4d6fc21518c', '{bcrypt}$2a$10$/f6qc5liQvYuZMUZlec3aOcZqd.TKxtmOtmVTJzyxVupoK31zGCW.', NULL, 'snsapi_base,snsapi_userinfo', 'authorization_code,refresh_token,implicit', 'http://127.0.0.1:123', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `oauth_code`  (
  ...
  `authentication` blob,
  `create_date` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '用于记录 code 创建时间，长时间未使用，code 过期，数据无意义，可用于判断并手动删除'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
